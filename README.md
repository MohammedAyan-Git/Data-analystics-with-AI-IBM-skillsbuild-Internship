...
│
├── notebooks/
│   └── TanishqBanger_Healthcare_Data_Analysis_and_Patient_Insights.ipynb
│
├── scripts/
...
| File                                                                             | Description                        |
| -------------------------------------------------------------------------------- | ---------------------------------- |
| `notebooks/TanishqBanger_Healthcare_Data_Analysis_and_Patient_Insights.ipynb`    | Main data analysis and ML notebook |
| `TanishqBanger_Healthcare_Data_Analysis_and_Patient_Insights_ProjectReport.docx` | Project report                     |
